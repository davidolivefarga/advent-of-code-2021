...
https.get(`https://adventofcode.com/2021/day/${dayNumber}`, (res) => {
	res.on("data", (data) => {
...
https.get(
	`https://adventofcode.com/2021/day/${dayNumber}/input`,
	{
		headers: {
...
function createReadmeSkeleton(dayNumber, dayTitle) {
	return formatText(
        ...
        You can find the puzzles [here](https://adventofcode.com/2021/day/${dayNumber}).
